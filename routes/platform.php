...
// use Orchid\Support\Controllers\Systems\AsyncController;
...
use App\Orchid\Screens\NewsCategory\NewsCategoryScreen;
...
// Route::screen('news/{role}/edit', NewsEditScreen::class)
//             ->name('platform.systems.roles.edit')
//             ->breadcrumbs(fn (Trail $trail, $role) => $trail
//                 ->parent('platform.systems.roles')
//                 ->push($role->name, route('platform.systems.roles.edit', $role)));
        
Route::screen('news-category', NewsCategoryScreen::class)
...
// Route::screen('/async/{method}/{arguments?}', AsyncController::class)
//             ->name('platform.async')
//             ->where('arguments', '.*');
// Products