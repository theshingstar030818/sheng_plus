            ...
            <div class="col-sm-12 col-md-12 top-img-content">
                ...
                <div class="bottom-imgs-container">
                    <div class="item-wrapper">
                        <div class="item">
                            <a href="{{ url('/product-cate/'.$product_cates[0]->id.'/0')}}">
                                <img src="{{ asset('images/about-us/about-us-icon-1.png') }}" alt="">
                                <!-- <p>研磨切斷砂輪片</p> -->
                            </a>
                        </div>
                        <div class="item">
                            <a href="{{ url('/product-cate/'.$product_cates[1]->id.'/0')}}">
                    ...
                    <div class="item-wrapper">
                        <div class="item">
                            <a href="{{ url('/product-cate/'.$product_cates[2]->id.'/0')}}">
                                <img src="{{ asset('images/about-us/about-us-icon-3.png') }}" alt="">
                                <!-- <p>手持打包機</p> -->
                            </a>
                        </div>
                        <div class="item">
                            <a href="{{ url('/product-cate/'.$product_cates[3]->id.'/0')}}">
